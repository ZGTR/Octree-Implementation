...
namespace Octree_ZGTR_WPFApp.Engine.OctreeTree.OctreeTypes
{
    class GIFHelper
    {
        ...
        public static void SaveGIFWithCustomColorTable(string destString, byte[] indexedImage, ColorTable colorTable, int imageWidth, int imageHeight)
        {
            ...
            foreach (System.Drawing.Color color in colorTable.Table)
            {
            ...
            FileStream stream = new FileStream(destString, FileMode.Create);
